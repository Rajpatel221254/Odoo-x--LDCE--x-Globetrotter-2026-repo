...
const DETAIL_DELAY_MS = 250;      // delay between detail-enrichment requests
const GEOCODE_DELAY_MS = 300;     // delay between country geocode lookups
const COUNTRY_DELAY_MS = 1000;    // delay between countries

const ENRICH_WITH_DETAILS = false; // set true to fetch descriptions/images (slow + costs more credits)
